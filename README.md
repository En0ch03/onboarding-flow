...
**The palette came from the picture, not the other way round.** The background of the flow is a crimson brush stroke on black, chosen before any colour decision was made. An accent from another family would have put two products on one screen, so crimson is the accent, and it is spent only where the user acts: the primary button, the border of a selected answer, the progress fill. It never fills a wide surface and never colours body text, because what makes red push people away grows with saturation and with the area it covers rather than with the hue itself. Headings are set in Playfair Display, a high-contrast serif, and the interface in Figtree. Headings are semibold rather than light: what makes a headline feel solid is weight and contrast, not size, and a thin serif enlarged only looks more fragile.

Text is never written straight onto the picture. Every block of copy has a veil behind it that comes from the page background, so the contrast that matters is measured against the veil rather than against whichever part of the image happens to lie underneath.
